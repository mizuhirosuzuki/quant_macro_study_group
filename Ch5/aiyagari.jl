...
# Refactored from quant_macro_book/chapter5/Julia          #
# ======================================================= #
...
savefig("images/fig_density.pdf")
...
xlims!(6.8, 8)
ylims!(0.026, 0.030)
savefig("images/fig_aiyagari_supply_demand.pdf")
...
KT_transition, KT0_iteration_history, meaT = derive_transition(
    m_transition, K_SS0, K_SS1, v_SS1, mea_SS0, tau,
)
...
xlabel!("time")
ylabel!("capital")
savefig("images/fig_transition_K.pdf")

plot(1:NT, rT_transition, label="interest rate transition", linewidth=3)
xlabel!("time")
ylabel!("interest rate")
savefig("images/fig_transition_r.pdf")
